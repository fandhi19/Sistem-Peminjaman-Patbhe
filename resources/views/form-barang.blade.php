...
<body class="bg-[#f8fafc] text-gray-800 min-h-screen flex flex-col">
    ...
    <main class="flex-grow py-12 px-4">
        <div class="max-w-3xl mx-auto">
            <h1 class="text-3xl font-extrabold text-[#142b52] mb-2 text-center">Form Peminjaman Barang</h1>
            <p class="text-center text-[#555555] mb-8">Lengkapi data di bawah untuk mengajukan peminjaman barang.</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-[#d1d5db] p-6 sm:p-8">
                <form action="{{ route('form.barang.store') }}" method="POST" class="space-y-6">
                    ...
                    {{-- Kegiatan --}}
                    <div>
                        <label for="kegiatan" class="block text-sm font-medium text-[#333333]">Kegiatan <span class="text-red-500">*</span></label>
                    ...
                    {{-- Tujuan --}}
                    <div>
                        <label for="tujuan" class="block text-sm font-medium text-[#333333]">Tujuan <span class="text-gray-400">(opsional)</span></label>
                        <textarea name="tujuan" id="tujuan" rows="3"
                                  class="mt-1 block w-full rounded-lg border-[#d1d5db] shadow-sm focus:border-[#eab308] focus:ring-[#eab308] sm:text-sm p-3 border">{{ old('tujuan') }}</textarea>
                        @error('tujuan') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>

                    {{-- Barang --}}
                    <div>
                        <label for="barang_id" class="block text-sm font-medium text-[#333333]">Pilih Barang <span class="text-red-500">*</span></label>
                    ...
                    <div class="pt-2">
                        <button type="submit"
                            ...
                            <i class="fa-solid fa-paper-plane mr-2 text-[#eab308]"></i> Ajukan Peminjaman Barang
                        </button>
                    </div>
                </form>
            </div>
