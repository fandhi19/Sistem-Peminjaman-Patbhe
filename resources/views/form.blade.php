...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col">
    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-16 items-center">
            <a href="/" class="flex items-center space-x-3">
                <div class="rounded-full flex items-center justify-center text-white font-bold text-xl shadow-md">
    ...
    <main class="flex-grow py-12 px-4">
        <div class="max-w-3xl mx-auto">
            <h1 class="text-3xl font-extrabold text-gray-900 mb-2 text-center">Form Pengajuan Peminjaman Ruangan</h1>
            <p class="text-center text-gray-500 mb-8">Lengkapi data di bawah untuk mengajukan peminjaman.</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
                <form action="{{ route('form.peminjaman.store') }}" method="POST" class="space-y-6">
                    ...
                    {{-- Tujuan Kegiatan --}}
                    <div>
                        <label for="tujuan_kegiatan" class="block text-sm font-medium text-gray-700">Tujuan Kegiatan <span class="text-gray-400">(opsional)</span></label>
                        <textarea name="tujuan_kegiatan" id="tujuan_kegiatan" rows="3"
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm p-3 border">{{ old('tujuan_kegiatan') }}</textarea>
                        @error('tujuan_kegiatan') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>

                    {{-- Ruangan --}}
                    <div>
                        <label for="ruangan_id" class="block text-sm font-medium text-gray-700">Pilih Ruangan <span class="text-red-500">*</span></label>
                    ...
                    {{-- Jumlah Peserta --}}
                    <div>
                        <label for="jumlah_peserta" class="block text-sm font-medium text-gray-700">Jumlah Peserta <span class="text-gray-400">(opsional)</span></label>
